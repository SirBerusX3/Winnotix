#!/usr/bin/python3
#
# Ported from Hypnotix (linuxmint/hypnotix, GPLv3) usr/lib/hypnotix/common.py @ 0e0fa1c.
#
# Deliberately kept as close to upstream as possible so future Hypnotix fixes
# stay easy to merge. Exactly five things changed, all of them GLib/POSIX
# dependencies -- see roadmap.md section 3:
#
#   line 7    from gi.repository import GLib, GObject   -> removed
#   line 14   GLib.get_user_cache_dir() providers path  -> paths.PROVIDERS_PATH
#   line 18   GLib.get_user_cache_dir() favorites path  -> paths.FAVORITES_PATH
...
PROVIDERS_PATH = str(paths.PROVIDERS_PATH)

TV_GROUP, MOVIES_GROUP, SERIES_GROUP = range(3)

FAVORITES_PATH = str(paths.FAVORITES_PATH)
